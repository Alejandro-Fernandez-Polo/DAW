          ...
          <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
            ...
            <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
              ...
              <ul class="nav flex-column mb-auto">
                ...
                <li class="nav-item">
                  <a id="moviesHref" class="nav-link d-flex align-items-center gap-2" data-href="{{ url('movie') }}">
                    <svg class="bi">
                ...
                <li class="nav-item">
                  <a class="nav-link d-flex align-items-center gap-2" data-href="{{ url('select') }}">
                    <svg class="bi">
                      <use xlink:href="#list" />
                    </svg>
                    Select
